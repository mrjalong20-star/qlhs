...
export interface Assignment { id: string; className: string; teacherUsername: string; teacherName: string; lessonIds: string[]; examIds: string[]; title?: string; note?: string; createdAt: string; dueDate?: string; }
